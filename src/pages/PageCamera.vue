  ...
  <q-page class="constrain q-pa-md">
    ...
    <div class="text-center q-pa-md">
      <q-btn 
        ...
        @click="captureImage"
        round color="grey-10" icon="eva-camera" size="lg"/>
        <q-file 
          v-else
          @input="captureImageFallbac"
          label="Choose an image"
          accept="image/*"
          outlined v-model="imageUpload">
    ...
    <div class="row justify-center q-ma-md">
      <q-input class="col col-sm-6" v-model="post.location" :loading="locationLoading" label="Location" dense>
